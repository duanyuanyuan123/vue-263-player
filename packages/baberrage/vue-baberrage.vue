<template>
  <div class="baberrage-stage" :style="{width: boxWidthVal + 'px',height:boxHeightVal+'px'}" v-show="isShow" ref="stage">
...
import hyphenateStyleName from '../sdk/hyphenate-style-name'
...
export default {
  ...
  mounted () {
    ...
    if(!this.boxHeightVal){
       this.boxHeightVal = this.$refs.stage.parentNode.offsetHeight * 0.6
    };
    // 判断是否有设置lanes
    console.log(this.boxHeightVal);
    console.log(this.lanesCount);
